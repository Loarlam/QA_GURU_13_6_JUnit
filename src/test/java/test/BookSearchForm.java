...
public class BookSearchForm extends BaseTest {
    ...
    void parametrizingTestWithValueSource(String valueSource) {
        pageOfBookSearch.openingWebsite().
                settingFirstName(valueSource).
                checkingResultFormValues(valueSource);
    }
    ...
    void parametrizingTestWithCsvFileSource(String searchData, String expectedResult) {
        pageOfBookSearch.openingWebsite().
                settingYearFromSearch(searchData).
                checkingResultFormValues(expectedResult);
    }
    ...
    void parametrizingTestWithEnumSource(YearsWithBooks yearsWithBooks) {
        pageOfBookSearch.openingWebsite().
                ...
                checkingResultFormValues(yearsWithBooks.getDescription());
    }
